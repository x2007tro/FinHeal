      ...
      fluidRow(
        column(
          ...
          tags$div(
            ...
            tags$div(class = "pf_rpt_taxtble_div", numericInput(paste0("pf_rpt_taxtble_",curr_pers_id,"_inc_rrsp"), label = "RRSO Limit", value = curr_taxpar[[paste0(curr_pers_id, "_rrsp_max_contribution")]], width = entry_wid_m)),
            tags$div(class = "pf_rpt_taxtble_div", numericInput(paste0("pf_rpt_taxtble_",curr_pers_id,"_inc_tfsa"), label = "TFSA Limit", value = curr_taxpar[[paste0(curr_pers_id, "_tfsa_max_contribution")]], width = entry_wid_m))
          )
        ),
        column(
          6,
