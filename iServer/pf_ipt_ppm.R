...
lapply(1:nrow(property_shownact), function(i){
  ...
  observeEvent(input[[paste0("fp_ipt_ppm_",curr_ppty_id,"_inc_rent")]], {
    ...
    updateNumericInput(session, paste0("fp_ipt_ppm_",curr_ppty_id,"_ppm_mgmtfee"), value = input[[paste0("fp_ipt_ppm_",curr_ppty_id,"_inc_rent")]] * property_shownact$exp_pm_fee_perc[i])
  ...
  observeEvent(input[[paste0("fp_ipt_ppm_",curr_ppty_id,"_enter")]], {
    ...
    desc <- c('rental income','other income',
              ...
              'property tax','utility','insurance','water & sewer','strata',
    ...
    amnt <- c( input[[paste0("fp_ipt_ppm_",curr_ppty_id,"_inc_rent")]], input[[paste0("fp_ipt_ppm_",curr_ppty_id,"_inc_other")]],
              ...
              input[[paste0("fp_ipt_ppm_",curr_ppty_id,"_exp_pptytax")]], input[[paste0("fp_ipt_ppm_",curr_ppty_id,"_exp_util")]], input[[paste0("fp_ipt_ppm_",curr_ppty_id,"_exp_insu")]], input[[paste0("fp_ipt_ppm_",curr_ppty_id,"_exp_watnsew")]], input[[paste0("fp_ipt_ppm_",curr_ppty_id,"_exp_strata")]],
    ...
    ctgr <- c('Rental Income','Other Rental Income',
              ...
              'Property Tax','Utilities','Home Insurance','Water & Sewer','Strata',
